...
<div id="ribbon">
    ...
    <!-- breadcrumb -->
    <ol class="breadcrumb">
        <li><a href="{{ route('home') }}">home</a></li><li><a href="{{ route('master_keterangan_mem') }}">Keterangan Member</a></li><li>Create</li>
    </ol>
</div>
@endsection
                                ...
                                <div class="row">
                                    ...
                                    <section class="col col-10">
                                        <label class="input"> <i class="icon-prepend fa fa-key"></i>
                                            <input type="text" class="readonly" value="{{ $data }}" name="mk_code" placeholder="Auto Generate">
                                        </label>
                                    </section>
                                ...
                                <div class="row">
                                    ...
                                    <section class="col col-10">
                                        <label class="input"> <i class="icon-prepend fa fa-pencil-square-o"></i>
                                            <input type="text" name="mk_desc" id="mk_desc" placeholder="Information Member Desc">
                                        </label>
                                    </section>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <section class="col col-10">
                                        ...
                                        <label class="textarea"> <i class="icon-append fa fa-comment"></i>
                                            <textarea rows="4" name="mk_notes" id="mk_notes"></textarea> 
                                        </label>
                                    </section>
                                </div>
                            </fieldset>
           ...
           iziToast.question({
                ...
                buttons: [
                    ['<button style="background-color:#37b4a2;"> Save </button>', function (instance, toast) {
                        ...
                        var code = $('#mk_code').val();
                        var desc = $('#mk_desc').val();
                        var notes = $('#mk_notes').val();
                        
                        if (code == '') {
                            iziToast.warning({position: 'topRight',message: 'Keterangan Member Code Cannot be Empty! '});
                            instance.hide({ transitionOut: 'fadeOut' }, toast, 'button');
                            return false;
                        }else if (desc == '') {
                            iziToast.error({position: 'topRight',message: 'Keterangan Member Desc Cannot be Empty! '});
                            instance.hide({ transitionOut: 'fadeOut' }, toast, 'button');
                            return false;
                        }
                        ...
                        $.ajax({
                            url  : ('{{ route('master_save_keterangan_mem') }}'),
                            data : $('#save').serialize(),
                            type :'post',
