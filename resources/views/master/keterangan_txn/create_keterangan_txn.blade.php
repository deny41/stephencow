...
<div id="ribbon">
    ...
    <!-- breadcrumb -->
    <ol class="breadcrumb">
        <li><a href="{{ route('home') }}">home</a></li><li><a href="{{ route('master_keterangan_txn') }}">Keterangan Txn</a></li><li>Create</li>
    </ol>
</div>
@endsection
                                ...
                                <div class="row">
                                    ...
                                    <section class="col col-10">
                                        <label class="input"> <i class="icon-prepend fa fa-key"></i>
                                            <input type="text" class="readonly" value="{{ $data }}" name="mt_code" placeholder="Auto Generate" >
                                        </label>
                                    </section>
                                ...
                                <div class="row">
                                    ...
                                    <section class="col col-10">
                                        <label class="input"> <i class="icon-prepend fa fa-pencil-square-o"></i>
                                            <input type="text" name="mt_desc" id="mt_desc" placeholder="Procuct Name">
                                        </label>
                                    </section>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <section class="col col-10">
                                        ...
                                        <label class="textarea"> <i class="icon-append fa fa-comment"></i>
                                            <textarea rows="4" name="mt_notes"  id="mt_notes"></textarea> 
                                        </label>
                                    </section>
                                </div>
                            </fieldset>
           ...
           iziToast.question({
                ...
                buttons: [
                    ['<button style="background-color:#37b4a2;"> save </button>', function (instance, toast) {
                        ...
                        if (code == '') {
                            iziToast.warning({position: 'topRight',message: 'Keterangan Txn Code Cannot be Empty! '});
                            instance.hide({ transitionOut: 'fadeOut' }, toast, 'button');
                            return false;
                        }else if (desc == '') {
                            iziToast.error({position: 'topRight',message: 'Keterangan Txn Desc Cannot be Empty! '});
                            instance.hide({ transitionOut: 'fadeOut' }, toast, 'button');
                            return false;
                        }
                        ...
                        $.ajax({
                            url  : ('{{ route('master_save_keterangan_txn') }}'),
                            data : $('#save').serialize(),
                            type :'post',
