...
<div id="ribbon">
    ...
    <!-- breadcrumb -->
    <ol class="breadcrumb">
        <li><a href="{{ route('home') }}">Home</a></li><li>Keterangan Member</li>
    </ol>
</div>
@endsection
...
<div class="jarviswidget jarviswidget-color-darken" id="wid-id-0">
    ...
    <header>
        ...
        <h2>Master Keterangan Member </h2>
        <button class="btn btn-primary btn-sm pull-right " style="margin-right: 1%" onclick="window.location=('{{ route('master_create_keterangan_mem') }}')"><i class="fa fa-plus"></i> Add new</button>
    </header>
                ...
                <tbody>
                    @foreach ($data as $i => $p)
                        <tr>
                            ...
                            <td align="center">
                               <div class="btn-group">
                                  <a href="{{ $p->mk_code }}/edit_keterangan_mem" class="btn btn-sm txt-color-white bg-color-orange"><i class="fa fa-pencil-square-o"></i></a>
                                  <button class="btn btn-sm btn-danger confirmation" value="{{ $p->mk_code }}"><i class="fa fa-eraser"></i></button>
                                </div>
                            </td>
                        </tr>
                    @endforeach
