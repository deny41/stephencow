                                ...
                                <div class="row">
                                    ...
                                    <section class="col col-10">
                                        ...
                                        <label class="input"> <i class="icon-prepend fa fa-key"></i>
                                            <input type="text" class="readonly" value="{{ $data }}" name="ot_code" id="ot_code" placeholder="Auto Generate">
                                        </label>
                                    </section>
                                </div>
                            </fieldset>
                                ...
                                <div class="row" hidden>
                                    ...
                                    <label class="label">Name</label>
                                        <label class="input"> <i class="icon-prepend fa fa-pencil-square-o"></i>
                                            <input type="text" name="ot_name" id="ot_name" placeholder="Full Name">
                                        </label>
                                    </section>
                                </div>
                                <div class="row">
                                    ...
                                    <label class="label">Bank Name</label>
                                        <label class="input"> <i class="icon-prepend fa fa-pencil-square-o"></i>
                                            <input type="text"  name="ot_bank_temp_name" id="ot_bank_temp_name" placeholder="Bank Name" readonly="">
                                            <input type="hidden" name="ot_bank_name" id="ot_bank_name" placeholder="Bank Name" readonly="">
                                        </label>
                                    </section>
                                </div>
                                <div class="row">
                                    ...
                                    <label class="label">Product</label>
                                        <label class="input"> <i class="icon-prepend fa fa-pencil-square-o"></i>
                                            <input type="text" readonly="" name="ot_product" id="ot_product" placeholder="product">
                                        </label>
                                    </section>
                                </div>
                            ...
                            <fieldset>
                                <div class="row">
                                    ...
                                    <label class="label">First Credit</label>
                                        <label class="input"> <i class="icon-prepend fa fa-pencil-square-o"></i>
                                            <input type="text" class="mask_money11 mask_money right_align"  value="0" name="ot_first_credit" id="ot_first_credit" placeholder="Transaction First Credit">
                                        </label>
                                    </section>
                                </div>
                                <div class="row">
                                    ...
                                    <label class="label">Penjualan</label>
                                        <label class="input"> <i class="icon-prepend fa fa-pencil-square-o"></i>
                                            <input type="text" class="mask_money11 mask_money right_align"  value="0" name="ot_sales" id="ot_sales" placeholder="Transaction Sales">
                                        </label>
                                    </section>
                                </div>
                                <div class="row">
                                    ...
                                    <label class="label">Pembelian</label>
                                        <label class="input"> <i class="icon-prepend fa fa-pencil-square-o"></i>
                                            <input type="text"  class="mask_money11 mask_money right_align"  value="0" name="ot_purchase" id="ot_purchase" placeholder="Transaction Purchase">
                                        </label>
                                    </section>
                                </div>
                                <div class="row">
                                    ...
                                    <label class="label">Nominal Promo</label>
                                        <label class="input"> <i class="icon-prepend fa fa-pencil-square-o"></i>
                                            <input type="text"  class="mask_money11 mask_money_1 right_align" value="0" name="ot_nominal_promo" id="ot_nominal_promo" placeholder="Transaction Promo">
                                        </label>
                                    </section>
                                </div>
                                <div class="row">
                                    ...
                                    <label class="label">Last Credit</label>
                                        <label class="input"> <i class="icon-prepend fa fa-pencil-square-o"></i>
                                            <input type="text" class="mask_money11 mask_money right_align"  value="0" name="ot_last_credit" id="ot_last_credit" placeholder="Transaction Last Credit">
                                        </label>
                                    </section>
                                </div>
                            ...
                            <fieldset>
                                <div class="row">
                                    ...
                                    <label class="label">Date</label>
                                        <label class="input"> <i class="icon-prepend fa fa-pencil-square-o"></i>
                                            <input type="text" name="ot_date" id="ot_date" value="yy-mm-dd" placeholder="Transaction Date">
                                        </label>
                                    </section>
                                </div>
                                <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <section class="col col-10">
                                        ...
                                        <label class="textarea"> <i class="icon-append fa fa-comment"></i>
                                            <textarea rows="4" name="ot_notes" id="ot_notes"></textarea> 
                                        </label>
                                    </section>
                                </div>
                            </fieldset>
...
<script type="text/javascript">
    ...
    window.onload = function(){
        ...
        $('#ot_member').change(function(){
            ...
            $('#ot_product').val($(this).find(':selected').data('product'));
           ...
           iziToast.question({
                ...
                buttons: [
                    ['<button style="background-color:#37b4a2;"> Save </button>', function (instance, toast) {
                        ...
                        $.ajax({
                            url  : ('{{ route('operational_save_transaction') }}'),
                            data : $('#save').serialize(),
                            type :'post',
                            success:function(data){
                                if (data.status == 'sukses') {
                                    ...
                                    iziToast.success({position: 'topRight',message: 'Created New Code And Successfully Saved!'});
                                    iziToast.warning({position: 'topRight',message: 'Data is alreadt exist!'});
                                    {{-- window.location=('{{ route('operational_transaction') }}') --}}
                                }else{
