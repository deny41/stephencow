...
<!-- PACE LOADER - turn this on if you want ajax loading to show (caution: uses lots of memory on iDevices)-->
        ...
        {{-- MaskMoney --}}
        <script src="{{ asset('assets/js/maskmoney/dist/jquery.maskMoney.min.js')}}"></script>
        {{-- Accounting --}}
        <script src="{{ asset('assets/js/accounting/accounting.min.js')}}"></script>
...
<script>
    ...
    $(document).ready(function() {
         ...
         */
        $(".mask_money").maskMoney({thousands:'.', decimal:'', allowZero:true,precision:0});
        $(".mask_money_1").maskMoney({thousands:'.', decimal:'', allowZero:true,allowNegative:true,precision:0});
        $('.select2').select2();
