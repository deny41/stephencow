...
<div id="ribbon">
    ...
    <!-- breadcrumb -->
    <ol class="breadcrumb">
        <li><a href="{{ route('home') }}">home</a></li><li><a href="{{ route('master_bank') }}">Bank</a></li><li>Create</li>
    </ol>
</div>
@endsection
                                ...
                                <div class="row">
                                    ...
                                    <section class="col col-10">
                                        <label class="input"> <i class="icon-prepend fa fa-key"></i>
                                            <input type="text" value="{{ $data }}" name="mb_code" placeholder="Bank Code">
                                        </label>
                                    </section>
                                ...
                                <div class="row">
                                    ...
                                    <section class="col col-10">
                                        <label class="input"> <i class="icon-prepend fa fa-pencil-square-o"></i>
                                            <input type="text" name="mb_name" id="mb_name" placeholder="Bank Name">
                                        </label>
                                    </section>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <section class="col col-10">
                                        ...
                                        <label class="textarea"> <i class="icon-append fa fa-comment"></i>
                                            <textarea rows="4" name="mb_notes" id="mb_notes"></textarea> 
                                        </label>
                                    </section>
                                </div>
                            </fieldset>
           ...
           iziToast.question({
                ...
                buttons: [
                    ['<button style="background-color:#37b4a2;"> Save </button>', function (instance, toast) {
                        ...
                        if (code == '') {
                            iziToast.warning({position: 'topRight',message: 'Bank Code Cannot be Empty! '});
                            instance.hide({ transitionOut: 'fadeOut' }, toast, 'button');
                            return false;
                        }else if (name == '') {
                            iziToast.error({position: 'topRight',message: 'Bank Name Cannot be Empty! '});
                            instance.hide({ transitionOut: 'fadeOut' }, toast, 'button');
                            return false;
                        }
